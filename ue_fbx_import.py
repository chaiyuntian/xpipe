...
# source ref:
# https://github.com/chaiyuntian/IDoLibrary/blob/master/UE4/UE_PipelineTool/Assemble/UE_AssembleTool.py

# TODO: https://github.com/ACaesuraIsStillMusic/Open-Virtual-Film-Project/blob/main/4.26/OVFPPlugin/Content/Python/OVFP_DDCToUEBridgeImporter.py
...
# --------------------------------------------------------------------------------------------------------- #
def import_fbx_asset(fbx_files=[], dest_path="/Game/new_folder", import_type="static_mesh", assemble_scale_factor=1):	
...
if args.JsonFileName:
	...
	import_fbx_asset(["S:\\Gosh_Project\\publicExchange\\personal\\Johnny\\temp\\testobj.fbx",
		"S:\\Gosh_Project\\publicExchange\\personal\\Johnny\\temp\\testobj2.fbx",
		"S:\\Gosh_Project\\publicExchange\\personal\\Johnny\\temp\\TestJSON\\objtest.fbx"])
